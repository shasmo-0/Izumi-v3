...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~FFNDattV",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Shasmo",
  BOT_NAME: process.env.BOT_NAME || "Slayer",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Slayer,❤️",
